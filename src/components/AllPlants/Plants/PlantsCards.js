        ...
        return(
            <div cclassName="container-fluid d-flex justify-content-center">
                <div className="row">
                    ...
                    <div className = "col-md-4"> <PlantsCard imgsrc={Mustasa} title ="Mustasa" description ="Brassica juncea, commonly brown mustard, Chinese mustard, Indian mustard, leaf mustard, Oriental mustard and vegetable mustard, is a species of mustard plant. "/></div>
                    <div className = "col-md-4"> <PlantsCard imgsrc={Pechay} title ="Pechay"  description ="Chinese cabbage can refer to two cultivar groups of leaf vegetables often used in Chinese cuisine: the Pekinensis Group and the Chinensis Group. These vegetables are both variant cultivars or subspecies of the turnip and belong to the same genus as such Western staples as cabbage, broccoli, and cauliflower. "/></div>
                    <div className = "col-md-4"> <PlantsCard imgsrc={Okra} title ="Okra"  description ="Okra or Okro, Abelmoschus esculentus, known in many English-speaking countries as ladies' fingers or ochro, is a flowering plant in the mallow family. It has edible green seed pods. The geographical origin of okra is disputed, with supporters of West African, Ethiopian, Southeast Asian, and South Asian origins."/></div>
